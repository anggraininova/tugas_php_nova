            ...
            <?php
                ...
                if(isset($_GET['proses'])){
                    ...
                    if($hitung <= 18.4){
                        ...
                        echo'
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            Halo, '.$nama.' . Nilai BMI anda adalah '.number_format($hitung,1).', anda termasuk Normal
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        ...
                        echo'
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            Halo, '.$nama.' . Nilai BMI anda adalah '.number_format($hitung,1).', anda termasuk Obesitas
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        ...
                        echo'
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            Halo, '.$nama.' . Nilai BMI anda adalah melebihi nilai BMI, anda termasuk Obesitas Akut
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
